...
public class Bills {
	...
	private final IntegerProperty project = new SimpleIntegerProperty();
	
	public final IntegerProperty projectProperty() {
		   return project;
		}
...
//	private final IntegerProperty net_amt = new SimpleIntegerProperty();
